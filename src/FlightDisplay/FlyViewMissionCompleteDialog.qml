    ...
    on_VehicleArmedChanged: {
        if (_vehicleArmed) {
            ...
            if (_showMissionCompleteDialog) {
                mainWindow.showComponentDialog(missionCompleteDialogComponent, qsTr("Misi Penyemprotan Selesai"), mainWindow.showDialogDefaultWidth, StandardButton.Close)
            }
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        QGCButton {
                            Layout.fillWidth:   true
                            Layout.alignment:   Qt.AlignHCenter
                            text:               qsTr("Lanjutkan Misi Dari Waypoint %1").arg(globals.guidedControllerFlyView._resumeMissionIndex)
